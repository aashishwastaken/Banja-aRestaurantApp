...
import { Text, View, StyleSheet, Modal, TextInput, Button, PanResponder, Alert, Share } from 'react-native';
...
function RenderDish(props) {
    ...
    const handleShare = (name, description, url) => {
        Share.share({
            title: name,
                ...
                >
                    ...
                    <View style={styles.row}>
                        ...
                        <Icon name="share-alt"
                            raised reverse
                            type="font-awesome-5"
                            onPress={() => handleShare(dish.name, dish.description, baseUrl + dish.image)}
                            color="green" 
                            size={20} />
                    </View>
                    <Modal
